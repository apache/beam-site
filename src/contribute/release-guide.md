...
1. Have at least three binding votes (from the PMC members)
...
Use reporter.apache.org to inform about the release and keep in the records (useful for the board reports).
...
1. reporter.apache.org is up to date with the release
