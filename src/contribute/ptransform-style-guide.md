...
* If the transform can have unprocessable (permanently failing) records and you want the pipeline to proceed despite that:
    ...
    * If bad records may need manual inspection by the user, emit them into an [additional output]({{ site.baseurl }}/documentation/programming-guide#transforms-outputs).
