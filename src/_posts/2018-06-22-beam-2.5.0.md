...
## Go SDK support
The Go SDK has been officially accepted into the project, after an incubation period and community effort. Go pipelines run on Dataflow and all portable runners, notably the Flink runner. More details are [here(https://beam.apache.org/documentation/sdks/go/)].
